...
def calculate_probabilities(draws, prior_UW=0.5, prior_UB=0.5):
    # Likelihoods
    likelihood_UW = 1
    likelihood_UB = 1
    for draw in draws:
    ...
    return posterior_UW / normalization, posterior_UB / normalization

# Function to simulate an agent's guess
def agent_guess(agent_id, draw_color, blackboard, draws):
    # Calculate probabilities
    prob_UW, prob_UB = calculate_probabilities(draws)
...
plt.title('Agent Confidence Levels Over Time')
